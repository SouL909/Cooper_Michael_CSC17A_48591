/*
    ...
    Version: 1 - Beginning process of building of building project for 17a
 * 
 */
...
struct name{                    //Template for including struct
    int *var1 = new int[5];     //For dice & Enum
    string var2;
};

enum Dices {ONE=1, TWO=2, THREE=3, FOUR, FIVE, SIX};
