/*
    ...
    Version: 2 - Turning previous main details into struct
    Converting previous protypes into new format that includes 
    pointers and more efficiency in the main.
    Still need to convert the actual functions - This version does not run
 */
