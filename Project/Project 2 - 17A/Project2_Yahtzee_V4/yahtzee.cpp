/*
 * This source file will contain the main processes of Yahtzee
 * 
 */
...
Yahtzee::Yahtzee() {
    ...
    this->round = 1;
    print_rules();
    //constructor, once class is made.
        ...
        if( ! gt_yhtz ) {
          for( int i = 0; i < 6; i++ ) {  
            ...
            if( rolCts[i] == 3 ) {
              ...
              for( int j = 0; j < 6; j++ )
                  scr3k += rolCts[j] * (j+1);
              //cout << "HAVE A 3-OF-A-KIND (at least): " 
              //<< (i+1) << " scr3k=" << scr3k << endl; 
              //debugging
              if( scr3k > 25 ) {
